...
void DisplayMenu()
{
    ...
    // Table header
    Console.WriteLine("{0,-5} {1,-15} {2, -15} {3,-20} {4, -15}", "S/N", "Company", "Role", "Link", "Status");
    Console.WriteLine(new string('-', 70));

    // Table rows
    foreach (JobApplication application in jobApplications)
    {
        Console.WriteLine("{0,-5} {1,-15} {2, -15} {3,-20} {4, -15}", jobApplications.IndexOf(application) + 1, application.Company, application.Role, application.Link, application.Status);
    }
    Console.WriteLine();
    Console.WriteLine();
